...
export default function RootLayout({
	...
	return (
		// If the text of your page will be in a language other than English, you should set the lang attribute on the <html> element to reflect that.
		<html lang="en">
			<body
						...
						<div className="container mx-auto px-4 py-8">
							<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
								...
								<div>
									...
									<p className="text-muted-foreground">
										{/* You can stract the main info or your page to a file so you can update it easy later*/}
							...
							<div className="mt-8 pt-8 border-t text-center text-muted-foreground">
								{/* use Date for make dynamics copyrigts so you dont need to update it every year */}
